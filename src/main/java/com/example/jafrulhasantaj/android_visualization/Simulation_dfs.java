    ...
    class BubbleSortThread extends Thread{
        ...
        public void run() {
            while (!finished){
                ...
                textlineColorUpdate(0, R.color.colorAccent); if (reset == true) continue;finalPause();
                waitsec(1);finalPause();
                textlineColorUpdate(0, R.color.colorW); if (reset == true) continue;finalPause();
                textlineColorUpdate(1, R.color.colorAccent); if (reset == true) continue;finalPause();
                waitsec(1);finalPause();
                textlineColorUpdate(1, R.color.colorW); if (reset == true) continue;finalPause();

                textlineColorUpdate(3, R.color.colorAccent); if (reset == true) continue;finalPause();
                waitsec(1);finalPause();
                textlineColorUpdate(3, R.color.colorW); if (reset == true) continue;finalPause();

                textlineColorUpdate(4, R.color.colorAccent); if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorW); if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorAccent); if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();

                imgUpdate(0, R.drawable.af); if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW); if (reset == true) continue;finalPause();
                waitsec(2);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorW);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                imgUpdate(3, R.drawable.bf);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                ...
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                imgUpdate(9, R.drawable.ef);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                waitsec(2);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                ...
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                imgUpdate(10, R.drawable.ff);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                ...
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                imgUpdate(4, R.drawable.cf);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                ...
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                imgUpdate(11, R.drawable.pf);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(4, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                ...
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
                imgUpdate(12, R.drawable.nf);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                waitsec(1);if (reset == true) continue;finalPause();
