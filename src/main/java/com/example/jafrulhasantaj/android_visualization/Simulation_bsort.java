            ...
            while (!finished){
                ...
                for (int i = 0; i < size && reset == false; i++){
                    ...
                    for (int j = 0; j < size - i - 1 && reset == false; j++){
                        ...
                        if (reset == true) continue;
                        textlineColorUpdate(3, R.color.colorAccent); finalPause();if (reset == true) continue;
                        textboxColorUpdate(j, R.color.colorAccent); finalPause();if (reset == true) continue;
                        textboxColorUpdate(j + 1, R.color.colorAccent);finalPause();if (reset == true) continue;
                        waitsec(1);
                        textlineColorUpdate(3, R.color.colorW);//finalPause();if (reset == true) continue;
                        if (array[j] > array[j + 1]) {
                            textlineColorUpdate(4, R.color.colorAccent);finalPause();if (reset == true) continue;
                            array = swap(array, j, j + 1);
                            textboxTextUpdate(j, array[j]);finalPause();if (reset == true) continue;
                            textboxTextUpdate(j + 1, array[j + 1]);finalPause();if (reset == true) continue;
                            textViuSizeUpdate(j, array[j]);
                            textViuSizeUpdate(j + 1, array[j + 1]); finalPause();if (reset == true) continue;
                            waitsec(1);
                        }
                        ...
                        textboxColorUpdate(j, R.color.colorB);finalPause();if (reset == true) continue;
                        textboxColorUpdate(j + 1, R.color.colorB);finalPause();if (reset == true) continue;
                        waitsec(1);
                        textlineColorUpdate(5, R.color.colorW);//finalPause();if (reset == true) continue;

                    }if (reset == true) continue;
                    textboxColorUpdate(lastIndex, R.color.colorPrimary);finalPause();if (reset == true) continue;
                    lastIndex--;
