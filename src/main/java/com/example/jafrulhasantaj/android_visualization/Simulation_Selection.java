        ...
        public void run() {
            while (!finished){
                ...
                for (int i = 0; i < size; i++){
                    ...
                    int minimum = i;if (reset == true) break;
                    ...
                    for (int j = i + 1; j < size; j++){
                        ...
                        textboxColorUpdate(minimum, R.color.colorAccent); finalPause();if (reset == true) break;
                        ...
                        if (array[minimum] > array[j]) {
                            ...
                            swap(array, minimum, j);if (reset == true) break;
                            textboxTextUpdate(minimum, array[minimum]);finalPause();if (reset == true) break;
                            textboxTextUpdate(j, array[j]);finalPause();if (reset == true) break;
                            textViuSizeUpdate(minimum, array[minimum]);if (reset == true) break;
                            textViuSizeUpdate(j, array[j]); finalPause();if (reset == true) break;
                            waitsec(1);if (reset == true) break;
                        }
                        textlineColorUpdate(5, R.color.colorW);//finalPause();
                        textlineColorUpdate(6, R.color.colorAccent);finalPause();if (reset == true) break;
                        textboxColorUpdate(minimum, R.color.colorB);finalPause();if (reset == true) break;
                        textboxColorUpdate(j, R.color.colorB);finalPause();if (reset == true) break;
                        waitsec(1);if (reset == true) break;
                        textlineColorUpdate(6, R.color.colorW);//finalPause();
                        if (reset == true) break;
                    }
                    textboxColorUpdate(minimum, R.color.colorPrimary);finalPause();if (reset == true) break;
                    lastIndex--;if (reset == true) break;
