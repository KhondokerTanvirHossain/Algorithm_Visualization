...
//                    textViuSizeUpdate(i, array[i]);
                ...
                for (int i = 0; i < size; i++){
                    textlineColorUpdate(1, R.color.colorAccent);if (reset == true) break;finalPause();
                    waitsec(1);if (reset == true) break;finalPause();
                    textlineColorUpdate(1, R.color.colorW);if (reset == true) break;finalPause();

                    textlineColorUpdate(2, R.color.colorAccent);if (reset == true) break;finalPause();
                    textboxColorUpdate(i, R.color.colorAccent);if (reset == true) break;finalPause();
                    keyboxColortUpdate(i, R.color.colorPrimary);if (reset == true) break;finalPause();
                    waitsec(1);if (reset == true) break;finalPause();
                    textboxEqualUpdate(i, R.color.colorPrimary);if (reset == true) break;finalPause();
                    waitsec(1);if (reset == true) break;finalPause();
                    textlineColorUpdate(2, R.color.colorW);if (reset == true) break;finalPause();
                    if (array[i] == key){
                        textlineColorUpdate(3, R.color.colorAccent);if (reset == true) break;finalPause();
                        waitsec(1);if (reset == true) break;finalPause();
                        textlineColorUpdate(3, R.color.colorW);if (reset == true) break;finalPause();
                        break;
                    }
                    textboxEqualUpdate(i, R.color.colorW);if (reset == true) break;finalPause();
                    textlineColorUpdate(4, R.color.colorAccent);if (reset == true) break;finalPause();
                    keyboxColortUpdate(i, R.color.colorW);if (reset == true) break;finalPause();
                    waitsec(1);if (reset == true) break;finalPause();
                    textlineColorUpdate(4, R.color.colorW);if (reset == true) break;finalPause();
                    textboxColorUpdate(i, colorPrimary);if (reset == true) break;finalPause();
                    waitsec(1);if (reset == true) break;finalPause();
                }
