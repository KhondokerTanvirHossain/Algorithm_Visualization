...
import static com.example.jafrulhasantaj.android_visualization.R.color.colorPrimary;
    ...
    class BubbleSortThread extends Thread{
        ...
        public void run() {
            while (!finished){
                ...
                mergeSort(array, 0, size - 1);if (reset == true) continue;finalPause();
                if (reset == true) continue;
                textlineColorUpdate(5, R.color.colorAccent);if (reset == true) continue;
                waitsec(1);if (reset == true) continue;finalPause();
                textlineColorUpdate(5, R.color.colorW);if (reset == true) continue;finalPause();
                finished = true;if (reset == true) continue;finalPause();
            }
        }
        void mergeSort(int[] array, int p, int r) {
            ...
            for (int i = 0; i < array.length; i++) {
                array[i] = oldarray[i];
                textboxColorUpdate(3, i + 2, R.color.colorPrimary);if (reset == true) return;
                textboxTextUpdate(3, i + 2, array[i]);if (reset == true) return;
            }
            for (int i = 0; i < 25; i++){
                textlineColorUpdate(i, R.color.colorW);
            }
            waitsec(1);if (reset == true) return;finalPause();
            textlineColorUpdate(1,R.color.colorAccent);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textlineColorUpdate(1,R.color.colorW);if (reset == true) return;finalPause();
            textlineColorUpdate(2,R.color.colorAccent);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textlineColorUpdate(2,R.color.colorW);if (reset == true) return;finalPause();
            textlineColorUpdate(3,R.color.colorAccent);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();

            textboxColorUpdate(3, 2, R.color.colorAccent);if (reset == true) return;finalPause();
            textboxColorUpdate(3, 3, R.color.colorAccent);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textboxColorUpdate(3, 2, R.color.colorW);if (reset == true) return;finalPause();
            textboxColorUpdate(3, 3, R.color.colorW);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 1, R.color.colorAccent);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 2, R.color.colorAccent);if (reset == true) return;finalPause();
            textboxTextUpdate(2, 1, array[0]);if (reset == true) return;finalPause();
            textboxTextUpdate(2, 2, array[1]);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 1, R.color.colorPrimary);if (reset == true) return;if (reset == true) return;finalPause();
            textboxColorUpdate(2, 2, R.color.colorPrimary);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            if (reset == true) return;finalPause();
            textlineColorUpdate(3,R.color.colorW);if (reset == true) return;finalPause();
            textlineColorUpdate(4,R.color.colorAccent);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            if (reset == true) return;finalPause();
            textboxColorUpdate(3, 4, R.color.colorAccent);if (reset == true) return;finalPause();
            textboxColorUpdate(3, 5, R.color.colorAccent);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textboxColorUpdate(3, 4, R.color.colorW);if (reset == true) return;finalPause();
            textboxColorUpdate(3, 5, R.color.colorW);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 4, R.color.colorAccent);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 5, R.color.colorAccent);if (reset == true) return;finalPause();
            textboxTextUpdate(2, 4, array[2]);if (reset == true) return;finalPause();
            textboxTextUpdate(2, 5, array[3]);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 4, R.color.colorPrimary);if (reset == true) return;finalPause();
            textboxColorUpdate(2, 5, R.color.colorPrimary);if (reset == true) return;finalPause();
            waitsec(1);if (reset == true) return;finalPause();
            if (reset == true) return;finalPause();
